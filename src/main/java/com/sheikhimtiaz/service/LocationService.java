...
import static com.sheikhimtiaz.constant.Constants.OPEN_MATEO_BASE_URL_GEOCODING;
import static com.sheikhimtiaz.constant.Constants.OPEN_MATEO_VERSION;
...
public class LocationService {
    ...
    public List<Location> getLocationsByCityName(String cityName, int size) throws IOException {
